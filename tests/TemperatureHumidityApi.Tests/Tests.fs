...
let createHost() =
    WebHostBuilder()
        ...
        .Configure(Action<IApplicationBuilder> TemperatureHumidityApi.App.configureApp)
        .ConfigureServices(Action<IServiceCollection> TemperatureHumidityApi.App.configureServices)
